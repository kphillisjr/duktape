...
def simple_download_file( out_path, web_url ):
	print "Attempting to download \"%s\"" % (web_url)
	opener = urllib2.build_opener()
	opener.addheaders = [('User-agent', 'Mozilla/5.0')]
	u = opener.open(web_url)
	f = open(out_path, 'wb')
	meta = u.info()
	print meta
...
if (os.name == 'nt') and not simple_resolve_file_path("npm_v2.13.4.zip"):
	simple_download_file("npm_v2.13.4.zip",
		"http://github.com/npm/npm/archive/v2.13.4.zip")
...
if (not simple_resolve_file_path("static/jquery.syntaxhighlighter.min.js")):
...
if (not simple_resolve_file_path("static/jquery.snippet.min.js")):
	simple_download_file("static/jquery.snippet.min.js",
		"http://steamdev.com/snippet/js/jquery.snippet.min.js")
if (not simple_resolve_file_path("static/jquery.snippet.min.css")):
...
if (not simple_resolve_file_path("static/prefixfree.min.js")):
...
if (not simple_resolve_file_path("static/reset.css")):
